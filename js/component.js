    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <div class="carousel-caption kb_caption kb_caption_right">
                <h3 data-animation="animated flipInX">Best Teachers</h3>
...
components.aboutScreen = `<div class="about">
<div class="container">
...
components.contactScreen = `<div class="contact">
<div class="container">
...
components.faqScreen = `<div class="faq-w3agile">
<div class="container">
...
components.helpScreen = `    <div class="help">
<div class="container">
...
components.loginScreen = `    <div class="login-page">
<div class="container">
    ...
    <h6> Not a Member? <a id="redirect-register">Sign Up Now »</a> </h6>
...
components.teacherScreen = `    <div class="wthree-offers">
<div class="container">
...
components.privacyScreen = `    <div class="privacy">
<div class="container">
...
components.productScreen = `    <div class="products">
<div class="container">
...
components.signUpScreen = `    <div class="login-page">
<div class="container">
    ...
    <div class="login-body">
        <form id="register-form">
            ...
            <input type="password" name="password" class="lock" placeholder="Password">
            <div class="error" id="error-password"></div>
            <label class="checkbox" style="margin-right: 20px"><input type="radio" name="checkboxRole" value="teacher"><i></i>Teacher</label>
            <label class="checkbox"><input type="radio" name="checkboxRole" value="student" checked><i></i>Student</label>
    ...
    <h6>Already have an account? <a id='redirect-login'>Login Now »</a> </h6>
</div>
</div>
<div class="w3agile-ftr-top">
<div class="container">
...
components.valueScreen = `    <div class="values">
<div class="container">
...
<div class="container">
<h1>Add course</h1>
<form id="createCourse" style="margin-bottom: 20px">
    ...
    <div class="form-group">
        <label for="exampleInputPassword1">Course link</label>
        <input type="text" name="courseLink" class="form-control" id="exampleInputPassword1">
    </div>
    <div class="form-group">
    ...
    <div class="form-row">
        <div class="form-group col-md-6" style="padding-left:0">
            ...
            <input type="text" class="form-control" name="author" id="inputCity">
        </div>
        <div class="form-group col-md-6">
            <label for="inputCity">Lessons</label>
            <input type="number" class="form-control" name="time" id="inputCity">
        </div>
    </div>
    <div class="form-group">
        <label for="exampleFormControlTextarea1">Desciption</label>
        <textarea class="form-control" name="users" id="exampleFormControlTextarea1" rows="3"></textarea>
    </div>
